...
public class TrustModifier_origin {
    ...
    private static final TrustModifier_origin MODIFIER = new TrustModifier_origin("TLS");

    private final SSLSocketFactory factory;

    private TrustModifier_origin(String protocol) {
        try {
